      ...
      <div className="w-full max-w-4xl bg-black rounded-lg shadow-2xl p-6 border-4 border-gray-800">
        ...
        <div className="flex justify-center mb-4">
          <div className="bg-black border-2 border-gray-800 px-6 py-3 rounded">
            <p
              className="text-yellow-500 text-6xl font-mono tracking-wider font-bold text-center flex justify-center"
        ...
        <div className="flex justify-between mb-3">
          <h2 className="text-white text-5xl px-6 font-bold ">{inputText} </h2>
          <h2 className="text-white text-5xl px-6 font-bold">{inputText2}</h2>
        </div>
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="bg-black border-2 border-gray-800 px-6 py-4 rounded w-64 text-center">
            <p
              className="text-red-600 text-8xl font-mono font-bold"
              ...
              <div className="flex items-center ่">
                ...
                <div
                  className={`h-4 w-4 rounded-full ${
                    homeBonus ? "bg-yellow-400" : "bg-gray-800"
                  }`}
                  style={{
                    boxShadow: homeBonus
          ...
          <div className="w-64 text-center">
            <div className="flex justify-between items-center ml-20">
              <div className="flex items-center">
                ...
                <div
                  className={`h-4 w-4 rounded-full ${
                    guestBonus ? "bg-yellow-400" : "bg-gray-800"
                  }`}
                  style={{
                    boxShadow: guestBonus
                      ? "0 0 8px rgba(255, 204, 0, 0.8)"
                      : "none",
                  }}
                ></div>
        ...
        <div className="grid grid-cols-3 gap-4 mt-8">
          ...
          <div className="space-y-2">
            <button
              ...
              className="bg-green-500 hover:bg-green-400 text-white py-2 rounded w-full"
            >
              {isRunning ? "Stop Timer" : "Start Timer"}
            </button>
            <button
              onClick={resetGame}
              className="bg-red-500 hover:bg-red-400 text-white py-2 rounded w-full"
            >
              Reset Game
            </button>
            <button
